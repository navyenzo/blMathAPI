...
#ifdef BL_ALGORITHMSLIB_HPP

//-------------------------------------------------------------------
// The following functors can be used as iterators
// to iterate over a string assuming the string
// reppresents an (nx1) column vector of number
// and when the iterator is dereferenced, it returns
// the number's value
//
// NOTE:  These iterators make use of functions defined
//        in the blAlgorithmsLIB library that can be found
//        at: https://github.com/navyenzo/blAlgorithmsLIB.git
//-------------------------------------------------------------------
